...
import RfidRegistrationModal from './RfidRegistrationModal';
...
function Navbar() {
  ...
  return (
    <>
          ...
          <Menu>
            ...
            {isAuth ? (
              <MenuList fontSize="1.1rem">
                ...
                <MenuItem 
                  icon={<BiTag size={24} color="#584bac" />}
                  onClick={onRfidModalOpen}
                >
                  Register RFID
                </MenuItem>
      ...
      <RfidRegistrationModal isOpen={isRfidModalOpen} onClose={onRfidModalClose} />
    </>
  );
}
